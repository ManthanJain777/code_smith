...
MERGE INTO seller_documents (id, seller_id, document_type, filename, checksum, parsed_data_json, verification_status) KEY(id) VALUES
...
MERGE INTO seller_verification_results (id, seller_id, connector_name, status, response_json) KEY(id) VALUES
...
MERGE INTO certificate_expiry_checks (id, bid_id, document_name, cert_type, expiry_date, submission_date, status, days_remaining) KEY(id) VALUES
...
MERGE INTO evidence_citations (id, compliance_result_id, document_id, document_name, page_num, snippet, extracted_value, extracted_unit, extraction_confidence) KEY(id) VALUES
...
MERGE INTO audit_logs (id, actor_id, actor_role, organization_id, action, resource_type, resource_id, timestamp, details) KEY(id) VALUES
